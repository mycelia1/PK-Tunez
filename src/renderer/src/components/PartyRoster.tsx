...
import nessWalkingUrl from '../assets/sprites/nesswalking.gif'
import nessPeaceUrl from '../assets/sprites/nesspeacesign.webp'
import evilMushroomUrl from '../assets/sprites/struttinevilmushroom1.webp'
